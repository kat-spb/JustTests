# 📆 Ежемесячный план и Гант по задачам (2025)
...
gantt
    ...
    section Контроль
    🎯 API-прототип :milestone, milestone, 2025-01-15, 0d
    section Контроль
    📸 Захват и фильтрация :milestone, milestone, 2025-04-15, 0d
    section Контроль
    📦 Интеграция и конфигурации :milestone, milestone, 2025-07-15, 0d
    section Контроль
    🧪 Финальные тесты :milestone, milestone, 2025-10-15, 0d
```