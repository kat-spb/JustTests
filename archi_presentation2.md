# Диаграммы AI-платформы как подсистемы, создаваемой с использованием компонентов платформы AIoT
...
graph TD
    ...
    Security --> Audit
```
## 8. Модель доменных данных на примере AISERVICE (один из вариантов мета-сущности TEMPLATE / сущности PROJECT)
